...
export interface TeamOutput {summary?:string;goal?:string;tasks?:string[];acceptance?:string[];items?:string[];issues?:string[];approved?:boolean;verified?:boolean;tests?:{action:string;selector:string;value?:string}[]}
...
export interface StudioRun {
  ...
  events:{stage:string;message:string;at:string;role?:string;state?:string;kind?:string;output?:TeamOutput}[];
  result:{pending?:PendingConfirmation;version?:number;summary?:string;draft_files?:GeneratedFile[];team?:Record<string,TeamOutput>;candidates?:{model:string;summary:string;files:GeneratedFile[];artifact:Artifact}[]};
}
