...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? 'AtomForge';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? 'AI 智能体应用工作台';
process.env.VITE_APP_TITLE = escapeHtmlAttr(process.env.VITE_APP_TITLE);
process.env.VITE_APP_DESCRIPTION = escapeHtmlAttr(process.env.VITE_APP_DESCRIPTION);
process.env.VITE_APP_LOGO_URL ??= process.env.OVERVIEW_LOGO_URL ?? '/atomforge.svg';
  ...
  return {
    plugins: [
      ...
      ...(process.env.PUBLIC_SITE_URL ? [Sitemap({
        hostname: process.env.PUBLIC_SITE_URL,
